...
export default function EnquiriesLeadsPage() {
  const [items, setItems] = useState([
    { id: '1', col1: 'Demo Lead 1', col2: 'Info A', col3: 'Info B', status: 'Active' },
    { id: '2', col1: 'Demo Lead 2', col2: 'Info C', col3: 'Info D', status: 'Inactive' },
  ]);
    ...
    <>
      <div className={styles.container}>
        <div className={styles.pageHeader}>
          <div>
            <h1 className={styles.title}>Enquiries & Leads</h1>
            <p className={styles.description}>Manage enquiries & leads records and details.</p>
          </div>
          ...
          <div className={styles.tableContainer}>
            <table className={styles.table}>
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th><th>Phone</th><th>Course Interest</th><th>Status</th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
