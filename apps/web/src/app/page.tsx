        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-brand-blue-dark via-brand-blue to-brand-blue-light p-6 shadow-sm">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-4">
              {/* Avatar */}
              <div className="h-12 w-12 rounded-full bg-white/15 border border-white/25 flex items-center justify-center text-white font-bold text-lg shadow-inner">
                A
              </div>
              <div>
                <p className="text-white/65 text-xs font-medium tracking-wide mb-0.5">Welcome back</p>
                <h2 className="text-white font-semibold text-xl tracking-tight">Akshay</h2>
