...
export default function ExaminationsPage() {
  const [items, setItems] = useState([
    { id: '1', col1: 'Demo Exam 1', col2: 'Info A', col3: 'Info B', status: 'Active' },
    { id: '2', col1: 'Demo Exam 2', col2: 'Info C', col3: 'Info D', status: 'Inactive' },
  ]);
      ...
      <div className={styles.container}>
        <div className={styles.pageHeader}>
          <div>
            ...
            <p className={styles.description}>Manage examinations records and details.</p>
          </div>
          ...
          <div className={styles.tableContainer}>
            <table className={styles.table}>
              <thead>
                <tr>
                  <th>ID</th>
                  <th>Exam Name</th><th>Class</th><th>Date</th><th>Status</th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
