...
const MOCK = [["001","Amit Kumar","Admin","IT","Active"],["002","Priya Menon","Teacher","Science","Active"],["003","Ravi Das","Teacher","Maths","Inactive"]];
  ...
  return (
    <div className={s.page}>
      <div className={s.pageHeader}>
        <div>
          <h1 className={s.pageTitle}>Staff & User Management</h1>
          <p className={s.pageDesc}>Manage staff members, roles, and access control.</p>
        </div>
      ...
      <div className={s.card}>
        ...
        <div className={s.tableWrap}>
          <table className={s.table}>
            <thead><tr><th>#</th><th>Name</th><th>Role</th><th>Department</th><th>Status</th><th></th></tr></thead>
            <tbody>
              {filtered.map((row, i) => (
                <tr key={i}>
